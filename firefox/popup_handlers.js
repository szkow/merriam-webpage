...
window.addEventListener("load", function () {
  ...
  background_port = browser.runtime.connect({name: "popup-port"});
  browser.runtime.onMessage.addListener(fillPopup);
...
function updateSearchHistory() {
    ...
    browser.storage.local.set({merriamswebpage_history});
